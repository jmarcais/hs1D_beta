classdef simulation_set
    ...
    methods(Access=public)
        ...
        function obj=instantiate_all_inputs_directory(obj)
            % option 1
%             obj.geologic_inputs_directory=strcat(obj.mother_folder_directory,'geologic.input');%obj.get_inputs(obj.mother_folder_directory,'GeologicInputs');
%             obj.morphologic_inputs_directory=strcat(obj.mother_folder_directory,'morphologic.input');%obj.get_inputs(obj.mother_folder_directory,'MorphologicInputs');
%             obj.hydrologic_inputs_directory=strcat(obj.mother_folder_directory,'hydrologic.input');%obj.get_inputs(obj.mother_folder_directory,'HydrologicInputs');
            % option 2
